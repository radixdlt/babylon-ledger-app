...
def test_sign_tx_ed25519_simple_transfer(firmware, backend, navigator):
    sign_tx_ed25519(firmware, backend, navigator, 13, "data/simple_transfer.txn")


def test_sign_tx_ed25519_simple_transfer_new_format(firmware, backend, navigator):
    sign_tx_ed25519(firmware, backend, navigator, 10, "data/simple_transfer_new_format.txn")


def test_sign_tx_ed25519_simple_transfer_nft(firmware, backend, navigator):
    sign_tx_ed25519(firmware, backend, navigator, 13, "data/simple_transfer_nft.txn")


def test_sign_tx_ed25519_simple_transfer_nft_by_id(firmware, backend, navigator):
    sign_tx_ed25519(firmware, backend, navigator, 13, "data/simple_transfer_nft_by_id.txn")


def test_sign_tx_ed25519_simple_transfer_nft_new_format(firmware, backend, navigator):
    sign_tx_ed25519(firmware, backend, navigator, 13, "data/simple_transfer_nft_new_format.txn")


def test_sign_tx_ed25519_simple_transfer_nft_by_id_new_format(firmware, backend, navigator):
    sign_tx_ed25519(firmware, backend, navigator, 13, "data/simple_transfer_nft_by_id_new_format.txn")


def test_sign_tx_ed25519_simple_transfer_with_multiple_locked_fees(firmware, backend, navigator):
    sign_tx_ed25519(firmware, backend, navigator, 10, "data/simple_transfer_with_multiple_locked_fees.txn")
