...
impl<T: Copy> TxState<T> {
    ...
    fn process_sign_internal(
        ...
        if class == CommandClass::Regular {
            ...
            match sign_mode {
                ...
                | SignMode::Ed25519Subintent
                | SignMode::Secp256k1Subintent => self.decode_tx_intent(comm.get_data()?, class)?,
            }
        }

        if class == CommandClass::LastData {
            if sign_mode == SignMode::Ed25519Subintent ||
                sign_mode == SignMode::Secp256k1Subintent {
    ...
    fn process_sign_auth(
        ...
        Self::as_hex(challenge, &mut nonce_hex);
    ...
    fn process_sign_pre_auth_hash(
        ...
        Self::as_hex(message, &mut message_hex);
    ...
    fn as_hex(message: &[u8], message_hex: &mut [u8; 64]) {
    ...
    fn finalize_sign_si(
        ...
        Self::as_hex(digest.as_bytes(), &mut message_hex);
    ...
    fn display_tx_info(&mut self, sign_mode: SignMode, digest: &Digest) -> Result<(), AppError> {
        ...
        match sign_mode {
            ...
            | SignMode::PreAuthHashSecp256k1
            | SignMode::Ed25519Subintent
            | SignMode::Secp256k1Subintent => Ok(()),
        }
    }
