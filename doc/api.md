...
| Data | Description |
|------|-------------|
| byte 0-31 | Device ID byte array |
...
interaction with the user. The [SignTxEd25519](#signtxed25519) always displays all instructions present in the transaction intent, while [SignTxEd25519Smart](#signtxed25519smart) tries to recognize type of the transaction and provide summary for the transaction.
