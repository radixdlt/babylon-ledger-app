...
|------------------|------------------|--------------------------------------------------------------------------------------------|
| GetAppVersion    | 0x10             | Get application version as 3 version components: __Major__, __Minor__ and __Patch Level__. |
...
| GetPubKeyEd25519 | 0x21             | Get derived public key for specified BIP32 derivation path using SLIP10 derivation         |
