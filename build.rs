fn main() {
    ...
    println!("cargo:rerun-if-changed=target-config/nanos.json");
    println!("cargo:rerun-if-changed=target-config/nanosplus.json");
    println!("cargo:rerun-if-changed=target-config/nanox.json");
    println!("cargo:rerun-if-changed=target-config/stax.json");
}
