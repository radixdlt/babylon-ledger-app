...
fn get_printer_for_type(param_type: ParameterType) -> &'static dyn ParameterPrinter {
    match param_type {
        ...
        ParameterType::BTreeMapByResourceMethodAuthKey => &IGNORED_PARAMETER_PRINTER,
        ...
        ParameterType::GlobalAddress => &IGNORED_PARAMETER_PRINTER,
        ...
        ParameterType::NonFungibleGlobalId => &IGNORED_PARAMETER_PRINTER,
        ParameterType::NonFungibleIdType => &IGNORED_PARAMETER_PRINTER,
        ParameterType::OptionOfBTreeMapByNonFungibleLocalId => &IGNORED_PARAMETER_PRINTER,
        ParameterType::OptionOfDecimal => &IGNORED_PARAMETER_PRINTER,
        ParameterType::OptionOfU32 => &IGNORED_PARAMETER_PRINTER,
...
impl ParameterPrinter for U32ParameterPrinter {
    ...
    fn display(&self, state: &ParameterPrinterState, display: &'static dyn DisplayIO) {
        ...
        let mut array = [0u8; 4];
        array.copy_from_slice(&state.data[..4]);
        let num = u32::from_be_bytes(array);

        display.scroll(arrform!(16, "{}u32", num).as_bytes());
    }
}
