...
pub const GLOBAL_PACKAGE: u8 = 0b00001101;
pub const GLOBAL_CONSENSUS_MANAGER: u8 = 0b10000110;
pub const GLOBAL_VALIDATOR: u8 = 0b10000011;
pub const GLOBAL_TRANSACTION_TRACKER: u8 = 0b10000010;
pub const GLOBAL_GENERIC_COMPONENT: u8 = 0b11000000;
pub const GLOBAL_ACCOUNT: u8 = 0b11000001;
pub const GLOBAL_IDENTITY: u8 = 0b11000010;
pub const GLOBAL_ACCESS_CONTROLLER: u8 = 0b11000011;
pub const GLOBAL_ONE_RESOURCE_POOL: u8 = 0b11000100;
pub const GLOBAL_TWO_RESOURCE_POOL: u8 = 0b11000101;
pub const GLOBAL_MULTI_RESOURCE_POOL: u8 = 0b11000110;
pub const GLOBAL_VIRTUAL_SECP256K1_ACCOUNT: u8 = 0b11010001;
pub const GLOBAL_VIRTUAL_SECP256K1_IDENTITY: u8 = 0b11010010;
pub const GLOBAL_VIRTUAL_ED25519_ACCOUNT: u8 = 0b01010001;
pub const GLOBAL_VIRTUAL_ED25519_IDENTITY: u8 = 0b01010010;
pub const GLOBAL_FUNGIBLE_RESOURCE_MANAGER: u8 = 0b01011101;
pub const INTERNAL_FUNGIBLE_VAULT: u8 = 0b01011000;
pub const GLOBAL_NON_FUNGIBLE_RESOURCE_MANAGER: u8 = 0b10011010;
pub const INTERNAL_NON_FUNGIBLE_VAULT: u8 = 0b10011000;
pub const INTERNAL_GENERIC_COMPONENT: u8 = 0b11111000;
pub const INTERNAL_ACCOUNT: u8 = 0b11111001;
pub const INTERNAL_KEY_VALUE_STORE: u8 = 0b10110000;
